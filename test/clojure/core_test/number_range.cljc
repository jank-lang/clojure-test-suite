...
(def ^:const max-int #?(:clj Long/MAX_VALUE
                        ...
                        :jank ((cpp/value (:member (std.numeric_limits jank.i64) max)))
                        :default 0x7FFFFFFFFFFFFFFF))

(def ^:const min-int #?(:clj Long/MIN_VALUE
                        :cljr Int64/MinValue
                        :cljs js/Number.MIN_SAFE_INTEGER
                        :jank ((cpp/value (:member (std.numeric_limits jank.i64) min)))
...
(def ^:const max-double #?(:clj Double/MAX_VALUE
                           ...
                           :jank ((cpp/value (:member (std.numeric_limits jank.f64) max)))
...
(def ^:const min-double #?(:clj Double/MIN_VALUE
                           ...
                           :jank ((cpp/value (:member (std.numeric_limits jank.f64) min)))
                           :default 4.9e-324))
